...
public class EnviarData

	{
     ...
     String url,urljson,sismojson;
     InputStream is = null;
     OutputStream os = null;
     String idevent,usuario,depth,locdatetime,lat,lon,comments,magnivalue,password;
     Boolean disponible;
     ...
     public EnviarData(HttpConnection httpConn, String url,String urljson,String sismojson, InputStream is,
			OutputStream os, String idevent,String usuario,String password,String depth,String locdatetime,String lat,String lon,String comments,String magnivalue,Boolean disponible) {
		super();
		this.httpConn = httpConn;
		this.url = url;
		this.urljson = urljson;
		this.sismojson = sismojson;
		this.is = is;
		this.os = os;
	...
	public String getsismojson() {
		return sismojson;
	}

	public void setsismojson(String sismojson) {
		this.sismojson = urljson;
	}
	...
	public void setUrljson(String sismojson) {
		this.sismojson = sismojson;
	}
	...
	//magnivalue
	public String getMagnivalue() {
		return magnivalue;
	}

	public void setMagnivalue(String magnivalue) {
		this.magnivalue = magnivalue;
	}
	...
	public String ConectarLogin(HttpConnection httpConn, String urll, String idevent, String usuario,String password,String depth,String comments) throws IOException{
		...
		/*El objeto HttpPost permite que enviemos una peticion de tipo POST a una URL especificada*/
		  ...
		  params.add(new BasicNameValuePair("depth",depth));
	...
	public String ConectarDataUsuario(HttpConnection httpConn, String urll, InputStream is,
			OutputStream os, String idevent, String usuario, String locdatetime,String lat,String lon,String comments,String magnivalue,Boolean disponible) throws IOException{
		...
		/*El objeto HttpPost permite que enviemos una peticion de tipo POST a una URL especificada*/
		  ...
		  //params.add(new BasicNameValuePair("comments",comments));
		  //params.add(new BasicNameValuePair("magnivalue",magnivalue));
		  ...
		  params.add(new BasicNameValuePair("conductor",idevent));
	...
	//Metodo que se encarga de enviar datos a sismologico.udo.edu.ve
	
	public String ConectarDataLista(HttpConnection httpConn, String urll, InputStream is,
			OutputStream os, String idevent, String usuario, String locdatetime,String lat,String lon,String comments,String magnivalue,Boolean disponible) throws IOException{
	...
	public String ConectarDataConfirmarTaxi(HttpConnection httpConn, String urll, InputStream is,
			OutputStream os, String name, String usuario, String locdatetime,String lat,String lon,String comments,String magnivalue,Boolean disponible) throws IOException{
		...
		/*Una vez añadidos los parametros actualizamos la entidad de httppost, esto quiere decir en pocas palabras anexamos los parametros al objeto para que al enviarse al servidor envien los datos que hemos añadido*/
		   ...
		   * try {
			   List<NameValuePair> params = new ArrayList<NameValuePair>();
	        	...
	        	params.add(new BasicNameValuePair("locdatetime", locdatetime));
	...
	private String getQuery(List<NameValuePair> params) throws UnsupportedEncodingException
	{
	 ...
	 public  JSONArray ObtenerSismojson(String url) throws IOException{
		 String resultado;
		 InputStream is = null;
	     String result = "";
	     //JSONObject json = null;
	 ...
	 *  //***********************************************************************************
	         ...
	         for(int i=0;i<result.length();i++){
	          ...
	          Log.i("log_tag","id"+json_data.getInt("account")+
	           ", nombre"+json_data.getString("idevent")+
...
//encPostData.append("locdatetime", String.valueOf(4));
encPostData.append("lat", lat);
encPostData.append("lon", lon);
encPostData.append("locdatetime", locdatetime);
